    ...
    <View style={{ backgroundColor: "#fff", flex: 1 }}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={{ gap: 10, marginTop: 10, justifyContent: "center" }}>
            <Text style={styles.profileName}>Georges Bueno Nova</Text>
            <View
              style={{
                alignItems: "center",
                gap: 10,
            ...
            >
              <Text style={styles.profileInfo}>+1 (829) 644 4677</Text>
              <Text style={styles.profileInfo}>Georgesbueno09@gmail.com</Text>
            </View>
          </View>
        </View>
      </View>
